...
async def chat_endpoint(request_data: QueryRequest):
    ...
    Returns the Pipeline Comparison payload:
    {
      "baseline": {
        "answer": "The original unverified draft...",
        "hallucinated_sentences": ["sentence that failed NLI check", ...]
      },
      "corrected": {
        "answer": "The final verified draft...",
    ...
    try:
        # Execute the LangGraph pipeline — returns structured baseline vs corrected payload
